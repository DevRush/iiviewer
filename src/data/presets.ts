...
export const VIEW_PRESETS: PresetView[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    cranialCaudal: -25,
    targetSystem: 'left',
    description: 'LM bifurcation, proximal LAD, entire LCx, OM bifurcations. Best overall LCx view.',
  ...
  },
  {
    ...
    cranialCaudal: 30,
    targetSystem: 'right',
    description: 'Distal RCA bifurcation, PDA origin visible in 98% of cases.',
